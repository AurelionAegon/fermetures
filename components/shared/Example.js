  ...
  return (
    <div className=" text-right ">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="text-slate-800 font-semibold inline-flex justify-center w-full px-4 py-2 text-sm    rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            Qui sommes-nous ?
            <ChevronDownIcon
              className="w-5 h-5 ml-2 -mr-1 text-slate-800 hover:text-violet-100"
              aria-hidden="true"
            />
          </Menu.Button>
        </div>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#EDE9FE"
        stroke="#A78BFA"
        d="M469.63,154.43h-7.23a0.49,0.49,0,0,0-.49.49v2.38a0.49,0.49,0,0,0,.49.49h7.23a0.49,0.49,0,0,0,.49-0.49v-2.38A0.49,0.49,0,0,0,469.63,154.43Zm-0.49,2.38h-6.25v-1.41h6.25v1.41Z"
        // transform="translate(-359.5 -102.55)"
      />
      <path
        strokeWidth="2"
