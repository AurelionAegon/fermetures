      ...
      <footer className="text-center lg:text-left bg-gray-100  text-gray-600">
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            <a href="#!" className="mr-6 text-gray-600 hover:text-sky-500 ">
            ...
            <a href="#!" className="mr-6 text-gray-600 hover:text-sky-500">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google"
                className="w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                <path fill="currentColor"
            ...
            <a href="#!" className="text-gray-600 hover:text-sky-500">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github"
                className="w-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                <path fill="currentColor"
          ...
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="">
              <h6 className="
                ...
                md:justify-start
              ">
                <img src={`/assets/images/logo.png`} className="w-8 mr-3"/>
                La française du pvc
              </h6>
              <p>
