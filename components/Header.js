    ...
    <div className="px-10 py-6 bg-white/40 mx-4 rounded-2xl absolute top-0 left-0 right-0 z-10 mt-6 ">
      <div className="flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center">
          <img src={`/assets/images/logo.png`}className="w-20  object-contain" alt="logo" />
        </Link>
        {/* logo end*/}
        ...
        <div className="md:flex items-center space-x-5 font-semibold text-slate-800 hidden">
          ...
          <div className="flex items-center space-x-2 border-2 border-blue-600 px-3 py-1.5 rounded hover:shadow-blue-400/50 hover:shadow-lg ease-in-out duration-200 hover:text-slate-800">
            ...
            <span className="hidden lg:block">
              <Link href="/FindPro">Trouver un pro</Link>
            </span>
          </div>

          <div className="hover:cursor-pointer flex items-center space-x-2 border-2 border-blue-600 px-3 py-1.5 rounded hover:shadow-blue-400/50 hover:shadow-lg ease-in-out duration-200 hover:text-slate-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="fill-current w-5 h-5"
